  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (!this.state.win) {
      ...
      if (win) {
        console.log("You Win!!");
        newWinState = {
          alertMessage: "You flagged all of the treasure! You win the game!",
          win: true
        };
      }
    }
...
//not [ 0, 0]
  ...
  clickMine() {
    ...
    setTimeout(function() {
      this.setState({
        alertMessage: "You revealed the treasure too soon! The lifeguard confiscates it. Better luck next time.",
        lose: true
      });
    }.bind(this), 300);
  }
